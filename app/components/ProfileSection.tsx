			...
			<div className="space-y-8 text-center">
				<div className="relative w-28 md:w-40 h-28 md:h-40 mx-auto">
					<div className="relative w-full h-full rounded-full overflow-hidden ring-2 ring-gray-200 dark:ring-gray-700">
						<Image src="/MePortrait.jpg" alt="Profile" fill className="object-cover" priority />
					</div>
				</div>

				<div className="space-y-3">
					<h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">Kenaan Khusayem</h1>
					...
					<p className="text-sm md:text-base text-gray-600 dark:text-gray-400 max-w-xs mx-auto leading-relaxed">
						3 years of experience with building web projects
					</p>
				</div>
				...
				<div className="space-y-4">
					...
					<div className="flex items-center justify-center space-x-2">
						...
						<a href="mailto:khkhusayem@gmail.com" className="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
							khkhusayem@gmail.com
						</a>
					</div>
					...
					<div className="flex items-center justify-center space-x-2">
						...
						<span className="text-sm text-gray-600 dark:text-gray-400">Morrisville, NC, 27560</span>
					</div>
