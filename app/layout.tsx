...
export const metadata: Metadata = {
	title: 'Kenaan Khusayem - Developer',
	description:
	...
	authors: [{ name: 'Kenaan Khusayem' }],
	creator: 'Kenaan Khusayem',
	openGraph: {
		title: 'Kenaan Khusayem - Developer Portfolio',
		...
		siteName: 'Kenaan Khusayem - Portfolio',
		images: [
			{
				url: '/og-image.jpg',
				width: 1200,
				height: 630,
				alt: 'Kenaan Khusayem - Developer Portfolio',
			},
		],
		locale: 'en_US',
		type: 'website',
